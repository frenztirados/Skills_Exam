...
for element in root.findall('record'):
    ...
    if count == 0:
        ...
        FirstDoseRefused = element.find('FirstDoseRefused').tag
        head.append(FirstDoseRefused)
    ...
    FirstDoseRefused = element.find('FirstDoseRefused').text
    nodes.append(FirstDoseRefused)
